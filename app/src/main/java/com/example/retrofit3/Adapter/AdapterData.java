package com.example.retrofit3.Adapter;
...
import com.example.retrofit3.Activity.IndexActivity;
import com.example.retrofit3.Activity.UbahActivity;
import com.example.retrofit3.Model.DataModel;
...
public class AdapterData extends RecyclerView.Adapter<AdapterData.HolderData> {
    ...
    private List<DataModel> list_akun;
    private int id;
    ...
    public class HolderData extends RecyclerView.ViewHolder {
        TextView tvId, tvNama, tvEmail, tvPassword;
                    ...
                    dialogPesan.setPositiveButton("Hapus", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            hand.postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    ((IndexActivity) ctx).retrieveData();
                                }
                            }, 1000);
                        }
                    });
        ...
        private void getData(){
            ...
            ambilData.enqueue(new Callback<ResponseModel>() {
                ...
                public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                    int kode = response.body().getKode();
                    String pesan = response.body().getPesan();
                    list_akun = response.body().getData();

                    int varIdAkun = list_akun.get(0).getId();
                    String varNamaAkun = list_akun.get(0).getNama();
                    String varEmailAkun = list_akun.get(0).getEmail();
                    String varPasswordAkun = list_akun.get(0).getPassword();
